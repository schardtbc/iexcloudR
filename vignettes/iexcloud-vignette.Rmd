...
During resistration at icloud.io you were given security tokens required to access this API. This wrapper will read those tokens from the .env file. The .env file must include the following three key pairs;
...
intraday <-historyFor("AAPL",date ="2019-02-15",chartIEXOnly = TRUE)
# Candlestick Chart
 intraday %>%
